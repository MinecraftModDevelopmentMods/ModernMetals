...
const conditions ={ armor: [ { type: 'basemetals:enabled',
		     ...
		     crossbowandbolts: [ { type: 'basemetals:enabled',
					  optionName: 'thing',
					   optionValue: 'CrossbowAndBolts' } ],
		    ...
		    stairs: [ { type: 'basemetals:enabled',
				optionName: 'thing',
				optionValue: 'Stairs' } ],
		    trapdoors: [ { type:'basemetals:enabled',
				optionName: 'thing',
				optionValue: 'Trapdoors' } ],
...
const patterns_basic = {
    ...
    bolt: { type: 'forge:ore_shaped',
	    ...
	    result: { material: 'BOLT',
		      count: 4 },
	    config: { enabled: [ 'CrossbowAndBolts', 'Rod' ] },
	    group: "weapon"  },
    ...
    crossbow: { type: 'forge:ore_shaped',
		...
		result: { material: 'CROSSBOW',
			  count: 1 },
		config: { enabled: [ 'CrossbowAndBolts', 'Rod', 'Gear' ] },
		group: "weapon"  },
    ...
    trapdoor: { type: 'forge:ore_shaped',
		...
		result: { material: 'TRAPDOOR',
			  count: 1 },
		config: { enabled: [ 'Trapdoors', 'Basics' ] },
		group: "misc" },
