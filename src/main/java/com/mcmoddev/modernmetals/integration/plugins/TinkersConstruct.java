...
public class TinkersConstruct extends com.mcmoddev.lib.integration.plugins.TinkersConstructBase implements IIntegration {
	...
	public void init() {
		...
		if (Materials.hasMaterial(MaterialNames.IRIDIUM)) {
		...
		if (Materials.hasMaterial(MaterialNames.MAGNESIUM)) {
		...
		if (Materials.hasMaterial(MaterialNames.MANGANESE)) {
		...
		if (Materials.hasMaterial(MaterialNames.RUTILE)) {
		...
		if (Materials.hasMaterial(MaterialNames.TANTALUM)) {
		...
		if (Materials.hasMaterial(MaterialNames.ZIRCONIUM)) {
